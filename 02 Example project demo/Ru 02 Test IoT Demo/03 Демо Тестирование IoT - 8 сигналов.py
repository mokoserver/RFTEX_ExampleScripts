...
RFSE.Stage("*********************************************************************")
RFSE.Stage("*************** Демо Tестирование IoT - 8 сигналов *******************")
RFSE.Stage("*********************************************************************")
RFSE.Stage(" ")
...
#description: измеряемое \nзначение, В;предел \nизмерения, В;процент \nдопустимой \nошибки, %;сигнал волны;амплитуда, В;предел\nамплитуды, В;частота, Гц;задержка\nперед\nизмерением, с;повторное \nизмерение,\nДа или Нет;число\nповторных \nизмерений
RFSE.Program('tree', 'set', 'select = Измерение напряжения с сигналом генератора rectangle$VDC_RECTANGLE')

RFSE.Stage('Устанавливаем имя графа => VDC_RECTANGLE_GRAPH')
...
#description: измеряемое \nзначение, В;предел \nизмерения, В;процент \nдопустимой \nошибки, %;сигнал волны;амплитуда, В;предел\nамплитуды, В;частота, Гц;задержка\nперед\nизмерением, с;повторное \nизмерение,\nДа или Нет;число\nповторных \nизмерений
RFSE.Program('tree', 'set', 'select = Измерение напряжения с сигналом генератора trapezoid$VDC_TRAPEZOID')

RFSE.Stage('Устанавливаем имя графа => VDC_TRAPEZOID_GRAPH')
...
RFSE.Program('tree', 'set', 'select = Измерение тока с сигналом генератора CMOS$IDC_CMOS')

RFSE.Stage('Устанавливаем имя графа => IDC_CMOS_GRAPH')
...
#description: измеряемое \nзначение, А;предел \nизмерения, А;процент \nдопустимой \nошибки, %;сигнал волны;амплитуда, А;предел\nамплитуды, А;частота, Гц;задержка\nперед\nизмерением, с;повторное \nизмерение,\nДа или Нет;число\nповторных \nизмерений
RFSE.Program('tree', 'set', 'select = Измерение тока с сигналом генератора pulse$IDC_PULSE')

RFSE.Stage('Устанавливаем имя графа => IDC_PULSE_GRAPH')
